...
public class MainActivity extends AppCompatActivity
{
    ...
    private void displayAboutDialog()
    {
        final Map<String, String> USED_LIBRARIES = ImmutableMap.of
                (
                        "Yoga (2015150061)", "https://www.instagram.com/yoga1197",
                        "Rosida El Rahma (2015150055)", "https://www.instagram.com/rosidael",
                        "Gandung K P (2015150057)", "https://www.instagram.com/gandung_kurniawan"
                );
